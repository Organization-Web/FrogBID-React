...
function GraphicDesign() {
    return (
        <div>
            ...
            <main>
                <InnerHeader title='Graphic Design' desc='Graphic Design'></InnerHeader>
                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-lg-8">
                                <div className="service-details__right-item">
                                    <h2 className="mb-30 text-capitalize">Elevate Your Brand with FrogBID Graphic Design
                                        Services</h2>
                                    <p className="mb-20">At FrogBID, we understand the power of visual storytelling. Our
                                        graphic
                                        design services are tailored to help businesses like yours stand out in today's
                                        crowded
                                        marketplace.</p>
                                    <p className="mb-60">Discover how our team of creative experts can bring your brand
                                        to life through
                                        compelling design solutions.</p>
                                    <div className="image mb-60">
                                        <img src="assets/images/portfolio/8-graphic-design/3.jpg" alt="image"/>
                                    </div>
                                    <div className="text-center">
                                        <a href="#" className="btn-one text-center mt-20" target="_blank">View Demo<i
                                            className="fa-regular fa-arrow-right ml-10"></i></a>
                                    </div>
                                    <ul className="list-text">
                                        <li className="mb-20">Visual Identity:
                                            <ul>
                                                <li>Developing logos, brand marks, and brand identities that represent
                                                    the essence and values of a brand or company.
                                                </li>
                                                <li>Creating style guides that define the visual elements of a brand,
                                                    including colors, typography, and imagery, to ensure consistency
                                                    across all communication channels.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Print Design:
                                            <ul>
                                                <li>Designing various printed materials such as business cards,
                                                    brochures, flyers, posters, and packaging that effectively convey
                                                    information and capture attention.
                                                </li>
                                                <li>Considering layout, typography, color, and imagery to create
                                                    visually appealing and impactful designs that resonate with the
                                                    target audience.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Digital Design:
                                            <ul>
                                                <li>Designing digital assets for websites, social media, email
                                                    marketing, and digital advertising campaigns.
                                                </li>
                                                <li>Creating web graphics, banners, infographics, and other digital
                                                    visuals that enhance user experience and engagement.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Advertising and Marketing Collateral:
                                            <ul>
                                                <li>Designing advertising campaigns and marketing collateral such as
                                                    banners, billboards, signage, and promotional materials to promote
                                                    products or services effectively.
                                                </li>
                                                <li>Crafting visually compelling advertisements that grab attention,
                                                    communicate key messages, and drive action.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">User Interface (UI) and User Experience (UX) Design:
                                            <ul>
                                                <li>Designing user interfaces for websites, mobile apps, and software
                                                    applications that are intuitive, user-friendly, and aesthetically
                                                    pleasing.
                                                </li>
                                                <li>Considering usability, accessibility, and user flow to create
                                                    seamless and engaging digital experiences for users.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Illustration and Iconography:
                                            <ul>
                                                <li>Creating custom illustrations, icons, and visual elements that
                                                    enhance storytelling and add personality to brands and products.
                                                </li>
                                                <li>Using illustration to simplify complex ideas, convey emotions, and
                                                    communicate messages in a clear and engaging manner.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Motion Graphics and Animation:
                                            <ul>
                                                <li>Designing motion graphics, animations, and videos that bring static
                                                    designs to life and captivate audiences with dynamic visuals.
                                                </li>
                                                <li>Incorporating motion graphics and animation into digital marketing
                                                    campaigns, presentations, explainer videos, and social media
                                                    content.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Clipping Path:
                                            <ul>
                                                <li>Creating precise outlines or paths around objects in an image to
                                                    separate them from the background or to isolate specific elements.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Neck Join:
                                            <ul>
                                                <li>Editing or retouching images to seamlessly blend or join the neck
                                                    area of a subject, commonly used in portrait photography or fashion
                                                    photography.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-25">Drop Shadow:
                                            <ul>
                                                <li>Adding a shadow effect to objects or text in a design to create
                                                    depth, dimension, and visual interest.
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    <h3 className="mb-20">Why Choose FrogBID for Graphic Design?</h3>
                                    <p className="mb-25">Here's what sets us apart:</p>
                                    <ul className="list-text">
                                        <li className="mb-20">Strategic Approach: We begin by understanding your brand
                                            identity, target
                                            audience, and objectives to develop a customized design strategy that
                                            resonates with
                                            your audience.
                                        </li>
                                        <li className="mb-20">Creative Excellence: Our talented designers blend
                                            creativity with
                                            functionality to create visually stunning graphics that leave a lasting
                                            impression.
                                        </li>
                                        <li className="mb-20">Versatile Solutions: Whether you need logo design,
                                            branding collateral, or
                                            digital assets, we offer a comprehensive range of graphic design services to
                                            meet your
                                            needs.
                                        </li>
                                        <li className="mb-25">Timely Delivery: We understand the importance of deadlines
                                            and strive to
                                            deliver high-quality designs within agreed-upon timelines.
                                        </li>
                                    </ul>
                                    <p className="mb-30">With FrogBID, you'll receive more than just beautiful designs –
                                        you'll
                                        get strategic solutions that drive brand awareness, engagement, and loyalty.</p>
                                    <h3 className="mb-20">Our Graphic Design Process</h3>
                                    <p>Experience our seamless process for creating impactful designs:</p>
                                    ...
                                    <h3 className="text-capitalize mb-20">From Concept to Creation</h3>
                                    <p className="mb-20">We collaborate closely with you to understand your vision and
                                        goals, ensuring
                                        that every design element aligns with your brand identity and messaging.</p>
                                    <p className="mb-20">Partner with FrogBID to unlock the full potential of your brand
                                        through
                                        exceptional graphic design. Contact us today to discuss your design needs and
                                        elevate your
