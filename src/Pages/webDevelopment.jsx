...
function WebDevelopment() {
    return (
        <div>
            ...
            <main>
                <InnerHeader title='Web Design & Development' desc='Web Design & Development'></InnerHeader>
                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-lg-8">
                                <div className="service-details__right-item">
                                    <h2 className="mb-30 text-capitalize">Crafting Your Digital Presence with
                                        FrogBID</h2>
                                    <p className="mb-20">In today's digital age, your website is often the first point
                                        of contact for
                                        potential customers. Is your online presence making the right impression? At
                                        FrogBID , we specialize in creating stunning websites that captivate audiences
                                        and drive
                                        results.</p>
                                    <p className="mb-60">Discover how our web design and development services can
                                        elevate your brand,
                                        engage your audience, and propel your business to new heights.</p>
                                    <div className="image mb-60">
                                        <img src="assets/images/portfolio/7-website-design/3.jpg" alt="image"/>
                                    </div>
                                    <ul className="list-text">
                                        <li className="mb-20">Planning:
                                            <ul>
                                                <li>Defining the website's purpose, goals, target audience, and desired
                                                    functionality.
                                                </li>
                                                <li>Conducting research on competitors, industry trends, and best
                                                    practices.
                                                </li>
                                                <li>Creating a site map and wireframes to outline the website's
                                                    structure and navigation.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Design:
                                            <ul>
                                                <li>Developing the visual identity, including colors, typography, and
                                                    imagery, to align with the brand's identity.
                                                </li>
                                                <li>Crafting mockups or prototypes of the website's layout and design
                                                    using design tools like Adobe XD, Sketch, or Figma.
                                                </li>
                                                <li>Ensuring the design is responsive and optimized for various devices,
                                                    including desktops, tablets, and smartphones.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Development:
                                            <ul>
                                                <li>Writing code to bring the design to life using front-end
                                                    technologies such as HTML, CSS, and JavaScript.
                                                </li>
                                                <li>Integrating content management systems (CMS) like WordPress or
                                                    Drupal for easy content updates and management.
                                                </li>
                                                <li>Implementing functionality such as contact forms, e-commerce
                                                    features, and interactive elements.
                                                </li>
                                                <li>Optimizing the website for speed, performance, and search engine
                                                    visibility through techniques like minification, image optimization,
                                                    and SEO best practices.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Testing:
                                            <ul>
                                                <li>Conducting thorough testing to identify and fix any bugs, errors, or
                                                    issues with the website's functionality, usability, and
                                                    compatibility.
                                                </li>
                                                <li>Testing across multiple browsers, devices, and screen sizes to
                                                    ensure consistent performance and user experience.
                                                </li>
                                                <li>Gathering feedback from stakeholders and users to make necessary
                                                    adjustments and improvements.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Deployment:
                                            <ul>
                                                <li>Uploading the finalized website files to a web server and
                                                    configuring domain settings for public access.
                                                </li>
                                                <li>Setting up website analytics and tracking tools to monitor traffic,
                                                    user behavior, and performance.
                                                </li>
                                                <li>Implementing security measures such as SSL certificates and
                                                    firewalls to protect against cyber threats.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Maintenance:
                                            <ul>
                                                <li>Regularly updating and maintaining the website to ensure it remains
                                                    secure, up-to-date, and optimized for performance.
                                                </li>
                                                <li>Monitoring analytics data and making data-driven decisions to
                                                    improve the website's effectiveness and meet business goals.
                                                </li>
                                                <li>Providing ongoing support and troubleshooting for any technical
                                                    issues or user inquiries.
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <h3 className="mb-20">Our Approach to Web Design and Development</h3>
                                    <p className="mb-25">Here's why FrogBID is your ideal partner for web design and
                                        development:</p>
                                    <ul className="list-text">
                                        <li className="mb-20">Strategic Planning: We start by understanding your
                                            business goals, target
                                            audience, and brand identity to create a customized strategy for your
                                            website.
                                        </li>
                                        <li className="mb-20">Creative Design: Our talented designers craft visually
                                            stunning and
                                            user-friendly interfaces that reflect your brand's unique personality and
                                            resonate with
                                            your audience.
                                        </li>
                                        <li className="mb-20">Responsive Development: We build responsive websites that
                                            adapt seamlessly
                                            to any device, ensuring an optimal user experience across desktops, tablets,
                                            and
                                            smartphones.
                                        </li>
                                        <li className="mb-25">Cutting-Edge Technology: Leveraging the latest tools and
                                            technologies, we
                                            develop scalable and feature-rich websites that meet the demands of today's
                                            dynamic
                                            digital landscape.
                                        </li>
                                    </ul>
                                    <p className="mb-30">With FrogBID, you'll get more than just a website – you'll get
                                        a
                                        powerful digital asset that drives conversions, fosters brand loyalty, and fuels
                                        business
                                        growth.</p>
                                    <h3 className="mb-20">Our Web Design and Development Process</h3>
                                    <p>Experience our streamlined process for creating exceptional websites:</p>
                                    ...
                                    <h3 className="text-capitalize mb-20">From Concept to Launch</h3>
                                    <p className="mb-20">We believe in transparency, collaboration, and excellence at
                                        every stage of the
                                        project. Our team works closely with you to bring your vision to life, ensuring
                                        that your
                                        website exceeds expectations and delivers tangible results.</p>
                                    <p className="mb-20">Partner with FrogBID to transform your online presence and stay
                                        ahead
                                        of the competition. Contact us today to discuss your web design and development
                                        needs.</p>
