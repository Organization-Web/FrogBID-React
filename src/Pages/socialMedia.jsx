...
function SocialMedia() {
    return (
        <div>
            ...
            <main>
                <InnerHeader title='Social Media Marketing' desc='Social Media Marketing'></InnerHeader>
                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-lg-8">
                                <div className="service-details__right-item">
                                    <h2 className="mb-30 text-capitalize">Maximize Your Social Media Marketing
                                        Impact</h2>
                                    <p className="mb-20">Unlock the full potential of your brand's presence on social
                                        media platforms.
                                        From engaging content to targeted advertising, every aspect of your social media
                                        strategy
                                        can drive growth and foster meaningful connections with your audience.</p>
                                    <p className="mb-60">Discover how we elevate brands through strategic social media
                                        marketing
                                        initiatives tailored to meet their unique goals and objectives.</p>
                                    <div className="image mb-60">
                                        <img src="assets/images/portfolio/3-social-media/3.jpg" alt="image"/>
                                    </div>
                                    <h3 className="mb-20">Key components of social media marketing include:</h3>
                                    <ul className="list-text">
                                        <li className="mb-20">Social Media Strategy: Developing a comprehensive plan
                                            that outlines
                                            goals, target audience, messaging, content themes, posting frequency, and
                                            performance
                                            metrics.
                                        </li>
                                        <li className="mb-20">Content Creation: Producing high-quality and relevant
                                            content tailored to
                                            each social media platform, including posts, images, videos, stories, and
                                            infographics.
                                        </li>
                                        <li className="mb-20">Audience Engagement: Actively engaging with followers by
                                            responding to
                                            comments, messages, and mentions, fostering conversations, and building
                                            relationships
                                            with your audience.
                                        </li>
                                        <li className="mb-20">Community Management: Monitoring social media channels for
                                            brand mentions,
                                            comments, and feedback, and addressing customer inquiries, concerns, or
                                            issues promptly
                                            and professionally.
                                        </li>
                                        <li className="mb-20">Social Media Advertising: Running paid advertising
                                            campaigns on social
                                            media platforms to increase reach, target specific audiences, promote
                                            products or
                                            services, and drive conversions.
                                        </li>
                                        <li className="mb-20">Influencer Marketing: Collaborating with social media
                                            influencers or
                                            thought leaders in your industry to reach a wider audience, build
                                            credibility, and
                                            increase brand visibility.
                                        </li>
                                        <li className="mb-20">Analytics and Reporting: Tracking key performance
                                            indicators (KPIs) such
                                            as engagement metrics, follower growth, website traffic, and conversion
                                            rates, and using
                                            data insights to refine strategies and optimize campaign performance.
                                        </li>
                                        <li className="mb-20">Cross-Promotion: Integrating social media marketing
                                            efforts with other
                                            digital marketing channels such as email marketing, content marketing, and
                                            search engine
                                            optimization (SEO) to create a cohesive and integrated marketing approach.
                                        </li>
                                    </ul>
                                    <h3 className="mb-20">Crafting Your Social Media Strategy</h3>
                                    <p className="mb-25">Here's how we kickstart your social media journey:</p>
                                    <ul className="list-text">
                                        <li className="mb-20">Identifying your target audience and understanding their
                                            preferences and
                                            behaviors to create highly engaging content.
                                        </li>
                                        <li className="mb-20">Developing a comprehensive content calendar to ensure
                                            consistent posting
                                            and maintain brand visibility.
                                        </li>
                                        <li className="mb-20">Utilizing data analytics to measure campaign performance
                                            and optimize
                                            strategies for maximum impact.
                                        </li>
                                        <li className="mb-25">Leveraging social media advertising platforms to reach new
                                            audiences and
                                            drive conversions.
                                        </li>
                                    </ul>
                                    <p className="mb-30">By aligning your social media efforts with your business
                                        objectives, we help
                                        you build a strong online presence and foster meaningful relationships with your
                                        followers.</p>
                                    <h3 className="mb-20">Our Approach to Social Media Marketing</h3>
                                    <p>In today's dynamic digital landscape, staying relevant requires constant
                                        innovation and
                                        adaptation. Our approach to social media marketing involves:</p>
                                    ...
                                    <h3 className="text-capitalize mb-20">Elevating Your Brand with Social Media</h3>
                                    <p className="mb-20">Harnessing the power of social media platforms, we amplify your
                                        brand's message
                                        and expand your reach to new audiences. Through targeted advertising and
                                        strategic content
                                        creation, we help you stand out in a crowded digital space.</p>
                                    <p className="mb-20">Our team of social media experts combines creativity with
                                        data-driven insights
                                        to deliver impactful campaigns that drive engagement and foster brand loyalty.
                                        With our
                                        tailored approach, we empower brands to connect with their audience on a deeper
                                        level and
                                        achieve their business objectives.</p>
                                    <p>Partner with us to elevate your brand's presence on social media and unlock new
                                        opportunities
