...
function ReputationManagement() {
    return (
        <>
            ...
            <main>
                <InnerHeader title='Reputation Management' desc='Reputation Management'></InnerHeader>
                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-lg-8">
                                <div className="service-details__right-item">
                                    <h2 className="mb-30 text-capitalize">Protect and Enhance Your Online Reputation
                                        with FrogBID</h2>
                                    <p className="mb-20">In today's digital age, your online reputation can make or
                                        break your business.
                                        At FrogBID, we offer comprehensive Online Reputation Management (ORM) services
                                        to
                                        safeguard your brand's image and foster trust among your audience.</p>
                                    <p className="mb-60">Discover how our ORM strategies can help you maintain a
                                        positive online
                                        presence and mitigate any potential reputation threats.</p>
                                    <div className="image mb-60">
                                        <img src="assets/images/portfolio/9-online-reputation/3.jpg" alt="image"/>
                                    </div>
                                    <ul className="list-text">
                                        <li className="mb-20">Monitoring:
                                            <ul>
                                                <li>Monitoring mentions, reviews, comments, and conversations about the
                                                    individual, brand, or organization across various online platforms,
                                                    including social media, review sites, forums, and news articles.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Reputation Analysis:
                                            <ul>
                                                <li>Analyzing the sentiment, tone, and context of online mentions to
                                                    assess the overall reputation and identify areas of strength and
                                                    weakness.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Review Management:
                                            <ul>
                                                <li>Managing online reviews and ratings by actively soliciting positive
                                                    reviews from satisfied customers, addressing negative reviews
                                                    promptly and professionally, and seeking resolutions to customer
                                                    complaints.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Content Creation and Promotion:
                                            <ul>
                                                <li>Creating and publishing positive and relevant content such as blog
                                                    posts, articles, press releases, and social media updates to
                                                    highlight accomplishments, showcase expertise, and counteract
                                                    negative content.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Search Engine Optimization (SEO):
                                            <ul>
                                                <li>Optimizing online content and web properties to improve search
                                                    engine rankings and ensure that positive information ranks higher
                                                    than negative or irrelevant content in search results.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Social Media Management:
                                            <ul>
                                                <li>Maintaining active and engaging social media profiles to interact
                                                    with followers, address inquiries and concerns, and amplify positive
                                                    brand messaging.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Crisis Management:
                                            <ul>
                                                <li>Developing and implementing strategies to manage online crises or
                                                    reputation-damaging events, including drafting crisis communication
                                                    plans, issuing public statements, and monitoring media coverage.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Online Brand Protection:
                                            <ul>
                                                <li>Taking proactive measures to protect the brand's online reputation,
                                                    such as monitoring for trademark infringement, counterfeit products,
                                                    and unauthorized use of intellectual property.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Influencer Engagement:
                                            <ul>
                                                <li>Collaborating with influencers and brand advocates to amplify
                                                    positive messaging, reach new audiences, and enhance credibility and
                                                    trustworthiness.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-25">Continuous Monitoring and Improvement:
                                            <ul>
                                                <li>Regularly monitoring online reputation metrics and feedback to
                                                    identify emerging issues, trends, or opportunities for improvement,
                                                    and adjusting strategies accordingly.
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    <h3 className="mb-20">Why Choose FrogBID for ORM?</h3>
                                    <p className="mb-25">Here's why we're the preferred choice for businesses:</p>
                                    <ul className="list-text">
                                        <li className="mb-20">Proactive Monitoring: We use advanced tools and techniques
                                            to monitor
                                            online mentions, reviews, and social media conversations, allowing us to
                                            address any
                                            issues before they escalate.
                                        </li>
                                        <li className="mb-20">Strategic Response: Our team of ORM experts crafts
                                            tailored responses to
                                            address negative feedback and promote positive interactions, demonstrating
                                            your
                                            commitment to customer satisfaction.
                                        </li>
                                        <li className="mb-20">Review Management: We help you manage and optimize your
                                            online reviews
                                            across various platforms, encouraging satisfied customers to share their
                                            experiences and
                                            bolstering your brand's credibility.
                                        </li>
                                        <li className="mb-25">Reputation Repair: In the event of a reputation crisis, we
                                            devise
                                            effective strategies to repair your brand's image and rebuild trust with
                                            your audience.
                                        </li>
                                    </ul>
                                    <p className="mb-30">With FrogBID as your ORM partner, you can rest assured that
                                        your
                                        brand's reputation is in capable hands. Let us help you safeguard your online
                                        image and
                                        maintain a positive brand perception.</p>
                                    <h3 className="mb-20">Our ORM Process</h3>
                                    <p>Experience our systematic approach to managing your online reputation:</p>
                                    ...
                                    <h3 className="text-capitalize mb-20">From Monitoring to Maintenance</h3>
                                    <p className="mb-20">We work tirelessly to monitor, analyze, and optimize your
                                        online presence,
                                        ensuring that your brand maintains a positive reputation across all digital
                                        channels.</p>
                                    <p className="mb-20">Don't let negative feedback tarnish your brand's image. Partner
                                        with FrogBID to protect and enhance your online reputation. Contact us today to
                                        learn more about
                                        our ORM services and take control of your brand's narrative.</p>
