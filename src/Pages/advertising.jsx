...
function Advertising() {
    return (
        <>
            ...
            <main>
                <InnerHeader title='Advertising' desc='Advertising'></InnerHeader>
                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-lg-8">
                                <div className="service-details__right-item">
                                    <h2 className="mb-30 text-capitalize">Maximize Your Reach with FrogBID Advertising
                                        Solutions</h2>
                                    <p className="mb-20">Ready to take your advertising efforts to the FrogBID level?
                                        Look no further than
                                        FrogBID. Our comprehensive advertising solutions are designed to help businesses
                                        like yours reach their target audience effectively and maximize ROI.</p>
                                    <p className="mb-60">Discover how our tailored advertising strategies can drive
                                        traffic, increase
                                        conversions, and boost your brand's visibility in today's competitive
                                        market.</p>
                                    <div className="image mb-60">
                                        <img src="assets/images/portfolio/10-advertising/3.jpg" alt="image"/>
                                    </div>
                                    <ul className="list-text">
                                        <li className="mb-20">Advertising Strategy:
                                            <ul>
                                                <li>Developing a comprehensive plan that outlines advertising goals,
                                                    target audience demographics, messaging, budget allocation, and
                                                    media channels to be utilized.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Creative Development:
                                            <ul>
                                                <li>Creating visually appealing and compelling advertisements, including
                                                    copywriting, design, and multimedia elements, tailored to resonate
                                                    with the target audience and communicate key messages effectively.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Media Planning and Buying:
                                            <ul>
                                                <li>Identifying the most relevant and cost-effective media channels to
                                                    reach the target audience, such as television, radio, print,
                                                    outdoor, digital, and social media platforms.
                                                </li>
                                                <li>Negotiating media placements, ad space, or airtime with publishers,
                                                    broadcasters, or ad networks to maximize reach and impact within the
                                                    allocated budget.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Campaign Execution:
                                            <ul>
                                                <li>Launching advertising campaigns across selected media channels,
                                                    scheduling ad placements, and managing ad creative rotation to
                                                    maintain visibility and frequency.
                                                </li>
                                                <li>Implementing tracking mechanisms and analytics tools to monitor
                                                    campaign performance, measure key metrics, and optimize strategies
                                                    for better results.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Targeting and Personalization:
                                            <ul>
                                                <li>Utilizing audience segmentation and targeting techniques to deliver
                                                    tailored advertising messages to specific demographic groups,
                                                    interests, behaviors, or geographic locations.
                                                </li>
                                                <li>Incorporating personalization elements such as dynamic content,
                                                    retargeting, and behavioral targeting to increase relevancy and
                                                    engagement.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-20">Performance Optimization:
                                            <ul>
                                                <li>Analyzing advertising data and insights to identify trends,
                                                    opportunities, and areas for improvement, and making adjustments to
                                                    optimize campaign performance and achieve desired outcomes.
                                                </li>
                                                <li>Testing different ad formats, messaging variations, and targeting
                                                    strategies through A/B testing or multivariate testing to determine
                                                    the most effective approaches.
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="mb-25">Compliance and Ethics:
                                            <ul>
                                                <li>Ensuring compliance with advertising regulations, industry
                                                    standards, and ethical guidelines, including truthfulness, accuracy,
                                                    and transparency in advertising claims and representations.
                                                </li>
                                                <li>Adhering to privacy regulations and data protection laws when
                                                    collecting and utilizing consumer data for targeted advertising
                                                    purposes.
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    <h3 className="mb-20">Why Choose FrogBID for Advertising?</h3>
                                    <p className="mb-25">Here's what sets us apart:</p>
                                    <ul className="list-text">
                                        <li className="mb-20">Targeted Campaigns: We create personalized advertising
                                            campaigns tailored
                                            to your audience demographics, interests, and behavior, ensuring maximum
                                            relevance and
                                            engagement.
                                        </li>
                                        <li className="mb-20">Multi-Channel Approach: From search engine ads to social
                                            media promotions,
                                            we leverage a variety of channels to reach potential customers wherever they
                                            are online.
                                        </li>
                                        <li className="mb-20">Data-Driven Insights: Our advertising strategies are
                                            backed by
                                            comprehensive data analysis, allowing us to optimize campaigns in real-time
                                            and maximize
                                            performance.
                                        </li>
                                        <li className="mb-25">Creative Excellence: Our team of skilled designers and
                                            copywriters crafts
                                            compelling ad creatives that resonate with your target audience and drive
                                            action.
                                        </li>
                                    </ul>
                                    <p className="mb-30">With FrogBID as your advertising partner, you can expect
                                        measurable
                                        results and a solid return on investment. Let us help you reach new heights with
                                        our
                                        innovative advertising solutions.</p>
                                    <h3 className="mb-20">Our Advertising Process</h3>
                                    <p>Experience our systematic approach to delivering successful advertising
                                        campaigns:</p>
                                    ...
                                    <div className="service-details__testimonial bg-image mb-60"
                                         data-background="assets/images/service/service-details-bg.jpg">
                                    ...
                                    <h3 className="text-capitalize mb-20">From Strategy to Execution</h3>
                                    <p className="mb-20">We work closely with you to develop a customized advertising
                                        strategy aligned
                                        with your business goals and objectives. Then, we execute the plan with
                                        precision,
                                        continuously optimizing performance for maximum impact.</p>
                                    <p className="mb-20">Ready to elevate your brand's visibility and drive growth
                                        through strategic
                                        advertising? Contact FrogBID today to learn more about our advertising services
                                        and
                                        start reaching your target audience like never before.</p>
